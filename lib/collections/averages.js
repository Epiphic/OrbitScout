...
////////////////////////////////////////SWITCHS PEED///////////////////////////////////////////////
		...
		teams[i].averages = {
			...
			scaleNotFound,
			teleSwitchSpeedFast, 
			teleSwitchSpeedMedium, 
			teleSwitchSpeedSlow, 
			teleSwitchSpeedverySlow, 
			teleScaleSpeedFast, 
			teleScaleSpeedMedium,
			teleScaleSpeedSlow, 
			teleScaleSpeedVerySlow, 
	...
	for(var i in teams){
		...
		var autoSwitchFoundREC = 0;
		var autoScaleFoundREC = 0;

		var autoSwitchScoredREC = 0;
		var autoScaleScoredREC = 0;
		var vaultScoredREC = 0;

		var switchFoundREC = 0;
		var switchNotFoundREC = 0;
		var scaleFoundREC = 0;
		var scaleNotFoundREC = 0;

		var teleSwitchSpeedFastREC = 0;
		var teleSwitchSpeedMediumREC = 0;
		var teleSwitchSpeedSlowREC = 0;
		var teleSwitchSpeedverySlowREC = 0;

		var teleScaleSpeedFastREC = 0;
		var teleScaleSpeedMediumREC = 0;
		var teleScaleSpeedSlowREC = 0;
		var teleScaleSpeedVerySlowREC = 0;
		...
		var climbSpeedFastREC = 0;
		var climbSpeedMediumREC = 0;
		var climbSpeedSlowREC = 0;		
		var climbSpeedVerySlowREC = 0;					

		var teleDiedREC = 0;
		var teleNotDiedREC = 0;

		var endgameNotPartREC = 0;
		var endgameParkREC = 0;
		var endgamePartnerClimbREC = 0;
		var endgame1botREC = 0;
		var endgame2botREC = 0;
		var endgame3botREC = 0;
		...
		for(var j = 1; j <= 3; j++){
			...
			teleSwitchScored += Last3.teleSwitchScored;
			teleScaleScored += Last3.teleScaleScored;
			vaultScored += Last3.teleVaultScored;

			teleSwitchAttempted += Last3.teleSwitchAttempted;
			teleScaleAttempted += Last3.teleSwitchAttempted;
...
////////////////////////////////////////SWITCHS PEED///////////////////////////////////////////////
			...
			if(Last3.endgame === "NotParked"){
				endgameNotPark += 1;
			}

			else if(Last3.endgame === "Parked"){
				endgamePark += 1;
			}
			...
			/////////////////////////////////////////////QUALITATIVE////////////////////////////////////////////////////
			qualitative = ("Match " + Last3.match + ": " + Last3.qualitative) + qualitative;
		...
		//AUTO TOTAL STATS
		var totalScaleCubeAverage = 0;
		var totalSwitchCubeAverage = 0;
		var totalBaselineAverage = 0;


		totalScaleGearAverage = round((teams[i].averages.gearSideWorked / (teams[i].averages.gearSideWorked+teams[i].averages.gearSideNotWorked)*100), 1);
		totalSwitchGearAverage = round((teams[i].averages.gearMiddleWorked / (teams[i].averages.gearMiddleWorked+teams[i].averages.gearMiddleNotWorked)*100), 1);
