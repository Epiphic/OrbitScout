...
export function SortedData(){
	...
	for(var i in teams){
		...
		var ChancetoHit_Baseline = Math.round((totalBaselineAverage*0.4) + (totalBaselineAverageREC*0.6));
		var ChancetoHit_MiddleGear = Math.round((totalMiddleGearAverage*0.4) + (totalMiddleGearAverageREC*0.6));
		var ChancetoHit_SideGear = Math.round((totalSideGearAverage*0.4) + (totalSideGearAverageREC*0.6));
...
export function AdvancedStats(teamtofind1, teamtofind2, teamtofind3){
	...
	for(var i = 1;i <=3; i++ ){
		if(BasicStats[teamtofind[i]].advancedaverages.ChancetoHit_MiddleGear>highScore){
			highTeam = BasicStats[teamtofind].matches[0].team;
			console.log(highTeam);
		}
	}	

	console.log(Math.max(BasicStats[teamtofind1].advancedaverages.ChancetoHit_MiddleGear,BasicStats[teamtofind2].advancedaverages.ChancetoHit_MiddleGear,BasicStats[teamtofind3].advancedaverages.ChancetoHit_MiddleGear))
