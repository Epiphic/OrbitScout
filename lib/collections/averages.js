...
//ALL THE MATH I NEEDED =========================================================================
	...
	var gearPerTeam = totalGears / 3
	var rotorchanceTeam1 = round(1 - normalcdf(BasicStats[teamtofind1].advancedaverages.totalGearsScoredAverage, teleGearsDeviationTeam1, gearPerTeam), 2);
	var rotorchanceTeam2 = round(1 - normalcdf(BasicStats[teamtofind2].advancedaverages.totalGearsScoredAverage, teleGearsDeviationTeam2, gearPerTeam), 2);
	var rotorchanceTeam3 = round(1 - normalcdf(BasicStats[teamtofind3].advancedaverages.totalGearsScoredAverage, teleGearsDeviationTeam3, gearPerTeam), 2);
