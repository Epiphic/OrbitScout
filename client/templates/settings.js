...
Template.settings.events({
	'click #Check': function () {
		...
		HTTP.call('GET', 'https://www.thebluealliance.com/api/v3/event/' + '2018onbar' + '/teams?X-TBA-Auth-Key=qFdMSZDjbHO7i5OYQl7MUW2oXz4Oxrr0z74s5GR89QVA2dcWx45dfu9HpHfoUtZd', {}, function(error, response) {
			Teams.set(response);			
		});
